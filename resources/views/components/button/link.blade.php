...
<a
    {{ $attributes->class([
        ...
        // Primary
        'bg-gray-800 dark:bg-gray-200 border border-transparent text-white dark:text-gray-800
         hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white
         active:bg-gray-900 dark:active:bg-gray-300 dark:focus:ring-offset-gray-800'
            => !$secondary,
