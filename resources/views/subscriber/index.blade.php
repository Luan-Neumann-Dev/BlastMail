                    ...
                    @foreach($subscribers as $subscriber)
                        <tr>
                            ...
                            <x-table.td>
                                ...
                                @else
                                    <span class="rounded-sm w-fit border border-red-500 bg-red-500 px-2 py-1 text-xs font-medium text-white dark:border-red-500 dark:bg-red-500 dark:text-white">Deleted</span>
                                @endunless
                            </x-table.td>
                        </tr>
                    @endforeach
